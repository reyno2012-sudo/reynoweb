...
export const SELECTED_PROJECTS: SelectedProject[] = [
  ...
  },
  {
    ...
    label: 'CREATIVE TOOL',
    description: '整理 Prompt 与生成图像的可视化笔记本，让灵感可以回看和复用。',
...
export const NOTE_ARTICLES: NoteArticle[] = [
  {
    ...
    readTime: 19,
    title: '别再做 AI Slop 了',
    summary: 'AI 能生成代码，但生成不了品味。九个世界级设计系统，给 Vibe Coder 一套审美标准。',
    tag: 'AI开发',
    month: '09',
    day: '02',
    year: '2026',
  ...
  },
  {
    ...
    category: 'WORKS',
    readTime: 5,
    title: '把 Markdown 写作者带回 X Article：我做了一个本地优先的长文编辑器',
    summary: '写作工具应该帮助你保持思路，而不是让你在发布前重新修一遍格式。 如果你习惯用 Markdown 写长文，大概遇到过这样的…',
    month: '09',
    day: '01'
  },
  {
